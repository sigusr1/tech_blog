...
![连接示意图](/assets/images/2019-05-26-linux_console_redirect/pc_com_dev.png)
...
![标准输入输出与串口设备的关系](/assets/images/2019-05-26-linux_console_redirect/std_with_ttyS.png)

用户通过telnet或者ssh登录后，会动态生成一个控制终端(比如/dev/pts/0)，如下图所示：

![未重定向的网络终端](/assets/images/2019-05-26-linux_console_redirect/net_console_no_redirect.png)
...
![重定向后的网络终端](/assets/images/2019-05-26-linux_console_redirect/net_console_redirect.png)
...
![重定向实现方式](/assets/images/2019-05-26-linux_console_redirect/implement.png)
