...
![重复注册JNI函数](/assets/images/2025-07-19-google_aosp_bad_code/google_asop_bad_code.jpg)

这个Bug虽然不会造成功能性的影响，但给人的感觉就是，AOSP的代码review是不是不太严格？

google收到这个bug反馈后，已经转为assigned状态，也就是已经将这个bug分配给开发人员进行修复了：

![assigned状态](/assets/images/2025-07-19-google_aosp_bad_code/aosp_assigned_my_bug_report.jpg)