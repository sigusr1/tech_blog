...
![AVTP报文格式](/assets/images/2020-04-12-avtp_summury/avtp_format.jpg)
...
![H264_AVTP_Header](/assets/images/2020-04-12-avtp_summury/avtp_h264_header.jpg)
...
![H264_AVTP_Header_wireshark](/assets/images/2020-04-12-avtp_summury/avtp_h264_header_wireshark.jpg)
...
![H264帧结构](/assets/images/2020-04-12-avtp_summury/frame_struct.jpg)  
...
![B帧解码显示示意图](/assets/images/2020-04-12-avtp_summury/b_frame.jpg)
...
![每种打包模式使用的rtp包类型](/assets/images/2020-04-12-avtp_summury/rtp_type.jpg)
...
![AVTP封装](/assets/images/2020-04-12-avtp_summury/avtp_pack.jpg)
...
![AVTP Presentation Time定义](/assets/images/2020-04-12-avtp_summury/avtp_present_time.png)


那么，Max Transit Time是如何定义的呢？如下图所示，如果音频源到两个扬声器的传输时间分别是t1、t2，Max Transit Time就是二者中的最大值。  

![Max Transit Time示意图](/assets/images/2020-03-22-AVB_summury/avb_in_house.png)  
...
![avtp_timestamp示意图](/assets/images/2020-04-12-avtp_summury/avtp_timestamp.jpg)
...
![同步播放示意图](/assets/images/2020-04-12-avtp_summury/Sync_by_avtp_timestamp.jpg)  
...
3. 媒体时钟恢复模块示意图如下所示：  
![媒体时钟恢复模块示意图](/assets/images/2020-04-12-avtp_summury/media_clock_recovery.gif)
...
![采集顺序](/assets/images/2020-04-12-avtp_summury/pts.jpg)  

但是，由于存在B帧，编码器实际的输出顺序如下，接收端也要按照下面的顺序解码：  

![编码输出顺序](/assets/images/2020-04-12-avtp_summury/dts.jpg)
...
3. [参考报文：gstream工具生成的报文](/assets/images/2020-04-12-avtp_summury/gstream_avtp.pcap)
