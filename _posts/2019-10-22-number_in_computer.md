...
![main函数的汇编代码](/assets/images/2019-10-22-number_in_computer/int_and_unsigned_convert.png)
...
- `-12345`在内存的低地址，`12345`在内存的高地址，示意图如下（局部变量入栈顺序受优化等级、栈保护等因素影响，不应对入栈顺序做任何假设）：  
	![栈状态](/assets/images/2019-10-22-number_in_computer/int_in_stack.jpg)  
...
![整数在内存中的表示](/assets/images/2019-10-22-number_in_computer/int_in_mem.png) 
...
![类型转换内存图](/assets/images/2019-10-22-number_in_computer/printf_unint.png) 
...
![整数比较大小的代码和内存图](/assets/images/2019-10-22-number_in_computer/compare.png) 


我们再对比下二者的汇编代码：

![整数比较大小的汇编代码](/assets/images/2019-10-22-number_in_computer/compare_assembly.png) 
...
![符号位扩展汇编代码](/assets/images/2019-10-22-number_in_computer/flag_expand_assembly.png) 
...
![符号位扩展gdb信息](/assets/images/2019-10-22-number_in_computer/flag_expand_runtime.png) 
...
![符号位扩展栈状态](/assets/images/2019-10-22-number_in_computer/flag_expand_stack.png) 
...
![数据截断汇编代码](/assets/images/2019-10-22-number_in_computer/int_cut.png) 
